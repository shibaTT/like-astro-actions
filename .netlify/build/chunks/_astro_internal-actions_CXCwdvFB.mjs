import { c as callSafely, a as ActionError, b as ActionInputError, g as getActionQueryString, d as ACTION_QUERY_PARAMS } from './shared_CvdkzHIJ.mjs';
import { createClient } from 'microcms-js-sdk';
import { L as LIKE_COOLDOWN } from './constants_DKB3379R.mjs';
import { A as AstroError, s as ActionCalledFromServerError } from './astro/assets-service_if9FHJvC.mjs';
import { i as isActionAPIContext } from './get-action_nmh-0TRp.mjs';
...
async function handleAction(param, path, context) {
  {
    const { getAction } = await import('./get-action_nmh-0TRp.mjs').then(n => n.a);
...
const client = createClient({
  serviceDomain: "with-like",
  apiKey: "bPKTRAGVlKN7rQV5OnHsm2WKoMCRjlhcsLt4"
});
  ...
  handler: async (input, ctx) => {
    try {
      ...
      if (lastLike && now - lastLike < LIKE_COOLDOWN) {
        return { success: false, error: `${LIKE_COOLDOWN / 1e3}秒間待ってからいいねしてください` };
      }
      await client.update({
        endpoint: "blogs",
        contentId: blogId,
